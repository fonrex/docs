...
title: "使用 Zipline 与 Backtrader 回测"
sidebar_label: "回测集成"
description: "如何导出 Fonrex 历史数据以使用 Zipline 和 Backtrader 回测量化策略"
---


# 使用 Zipline 与 Backtrader 回测
...
## 将数据提取到 Pandas DataFrame

使用 Python，直接将 Fonrex 历史 K 线提取到格式化用于回测的 Pandas DataFrame 中：

...
:::note Security
Your key is stored in the Google Apps Script User Properties — it is unique to your Google account, never stored in a cell, and will not be shared if you share the document with someone else.
:::
...
:::warning 30-minute cache
Custom formulas are cached by Google for 30 minutes. For fresh data, use the **Refresh** buttons in the menu instead of these formulas.
:::
